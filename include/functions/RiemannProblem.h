...
namespace FVM { 
    /**
     * @brief Contains the various equations needed to solve a Riemann problem. 
     * 
     * This is used in the exact Riemann problem fluxes, and eventually will be added to the exact solver.
     */
    namespace RiemannProblem {
        ...
        void solve_flux(double a_L, double a_R, double u_L, double u_R, double p_L, double p_R, double gamma_L, double gamma_R, double C_L, double C_R, double &u_star, double &a_star_L, double &a_star_R, double &p_star_L, double &p_star_R);
