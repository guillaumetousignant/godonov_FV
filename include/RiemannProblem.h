...
namespace RiemannProblem {
    ...
    void get_boundary_state(double &a_face, double &u_face, double &p_face, double delta_t, double a_L, double a_R, double u_L, double u_R, double p_L, double p_R, double gamma_L, double gamma_R, double u_star, double a_star_L, double a_star_R, double p_star_L, double p_star_R);
}
#endif